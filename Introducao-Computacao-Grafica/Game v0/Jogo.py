...
def display():
    ...
    glPushMatrix()
    # Corpo da nave
    glColor3f(0.0, 1.0, 1.1) # cor da nave (azul ciano)
   ...
   # Desenha vários ovnis
    for pos in ovni_posicoes:
        ...
        glMaterialfv(GL_FRONT, GL_SPECULAR, [1.0, 1.0, 1.0, 1.0])  # Componente especular branco
        glMaterialfv(GL_FRONT, GL_SHININESS, 50.0)  # Ajuste o valor de brilho especular conforme necessário
...
def init():
    ...
    light_position = [0.0, 0.0, 5.0, 1.0]  # Coordenadas da luz fixa
