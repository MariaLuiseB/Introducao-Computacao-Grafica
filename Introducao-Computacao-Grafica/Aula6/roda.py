...
def init():
    ...
    global roda_shader
    roda_shader = glCreateProgram()
    glAttachShader(roda_shader, vertexShader)
    glAttachShader(roda_shader, fragmentShader)
    glLinkProgram(roda_shader)
